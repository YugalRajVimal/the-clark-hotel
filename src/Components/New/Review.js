...
const Review = () => {
  ...
  return (
    <div ref={reviewRef} className="p-6 md:px-20 md:pb-20">
      <div className="h-[60vh] md:h-[50vh] bg-[#a67c52] flex md:flex-row flex-col justify-center">
        ...
        <div className="w-full md:w-full h-auto text-white flex flex-col gap-4 lg:gap-1 justify-evenly items-center text-center px-16 review-text">
          <p className="text-4xl review-rating">★★★★★</p>
          <p className="w-full md:w-[80%] lg:w-[70%] lg:p-10">
          Staying at Divya Kumbh Tent was a delightful experience! Luxurious tents, great amenities, and the boat ride made our visit unforgettable. Highly recommended!
          </p>
          <div className="flex flex-col justify-center items-center gap-2 review-rating">
            <div className="h-[50px] aspect-[1/1] bg-zinc-300 rounded-full overflow-hidden">
            <img src="/New/user.avif" className="h-full w-full object-cover" />
            </div>
